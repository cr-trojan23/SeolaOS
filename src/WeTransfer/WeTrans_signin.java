 ...
 * @author Srinivas
 */
public class WeTrans_signin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jInternalFrame1.getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 110, -1, -1));
        jInternalFrame1.getContentPane().add(p1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 260, 170, 30));
        ...
        jInternalFrame1.getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 300, -1, -1));
        ...
        jInternalFrame1.getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 360, -1, -1));

        jLabel6.setFont(new java.awt.Font("Ubuntu", 0, 24)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(153, 255, 255));
        jLabel6.setText("Password  :");
        jInternalFrame1.getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 270, -1, -1));
        ...
        jInternalFrame1.getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 360, -1, -1));

        jLabel5.setFont(new java.awt.Font("Ubuntu", 0, 24)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(153, 255, 255));
        jLabel5.setText("Email : ");
        jInternalFrame1.getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 200, -1, -1));
        jInternalFrame1.getContentPane().add(a1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 200, 170, 30));
        jInternalFrame1.getContentPane().add(a2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 200, 170, 30));
...
public static void dt() {    
       ...
       WeTrans_signin.date.setText(dtf.format(now));  
      }
        ...
        try {
            ...
            if (res.next()) {
                ...
                if(a1.getText().equals(user) && p1.getText().equals(pass))
                {
                    ...
                    WeTrans_home.a2.setText(user);
                    WeTrans_home.a2.setEditable(false);
                    WeTrans_home.animate_panel.setVisible(false);
                    dispose();
                }
                else
                {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            if (res.next()) {
                ...
                {                                                   //Final indicates that string cannot be changed
                    final String username = "noreply.seolaos@gmail.com";  //Mail ID of sender
                    final String password = "!@#456&*(0";                 //Password of sender

                    Properties prop = new Properties();
                    prop.put("mail.smtp.host", "smtp.gmail.com");  //Host of SMTP
                    prop.put("mail.smtp.port", "587");            //Port of host SMTP
                    ...
                    Session session = Session.getInstance(prop, new javax.mail.Authenticator()
                        ...
                        try {
                            ...
                            message.setSubject("WeTransfer Account Password");
