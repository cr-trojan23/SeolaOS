...
public class send_money extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        entert = new javax.swing.JTextField();
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/send_money.png"))); // NOI18N
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 330, 140, 120));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/ama_pay2.png"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(-410, 0, 1220, 160));

        amt.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        amt.setForeground(new java.awt.Color(153, 255, 255));
        amt.setText("Please wait while we send OTP");
        jPanel1.add(amt, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 490, -1, -1));

        amount.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        jPanel1.add(amount, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 330, 90, 30));

        pay_amt.setFont(new java.awt.Font("Ubuntu", 1, 48)); // NOI18N
        pay_amt.setForeground(new java.awt.Color(255, 51, 51));
        jPanel1.add(pay_amt, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 180, 160, 70));
        ...
        jPanel1.add(na_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 170, 160, 30));

        otp.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        jPanel1.add(otp, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 310, 140, 30));

        entert.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        entert.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                entertActionPerformed(evt);
            }
        });
        jPanel1.add(entert, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 280, 270, 30));

        enter.setFont(new java.awt.Font("Ubuntu", 1, 18)); // NOI18N
        enter.setForeground(new java.awt.Color(153, 255, 255));
        enter.setText("Enter Amazon Pay Email-ID");
        jPanel1.add(enter, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 290, -1, -1));
        ...
        jPanel1.add(mail, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 250, -1, -1));

        amt1.setFont(new java.awt.Font("Ubuntu", 1, 18)); // NOI18N
        amt1.setForeground(new java.awt.Color(153, 255, 255));
        amt1.setText("Amount");
        jPanel1.add(amt1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 330, -1, -1));
        ...
        jPanel1.add(sub, new org.netbeans.lib.awtextra.AbsoluteConstraints(292, 360, 90, -1));
        ...
        jPanel1.add(email, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 170, -1, -1));

        jScrollPane1.setViewportView(jPanel1);

        jInternalFrame1.getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 800, 470));
...
public static void dt() {    
       ...
       send_money.date.setText(dtf.format(now));  
      }
...
dispose();        // TODO add your handling code here:
                ...
                try {
                    ...
                    if (res.next()) 
                    {
                        ...
                        String pamt = res.getString("Amt");
                            if(Integer.valueOf(amnt)<Integer.valueOf(pamt))
                            {
                                try
                                    {
                                        Class.forName("java.sql.DriverManager");
                                        ...
                                        String qry = "update acc set Amt = Amt + '"+amnt+"' where email = '"+entert.getText()+"';";
                                        String q = "update acc set Amt = Amt - '"+amnt+"' where email = '"+email.getText()+"';";
    ...
    private void entertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_entertActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_entertActionPerformed

    private void jLabel10MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MousePressed
        amt1.setVisible(false);
        enter.setVisible(false);
        entert.setVisible(false);
    ...
    public static transient javax.swing.JTextField amount;
    ...
    public static transient javax.swing.JTextField entert;
