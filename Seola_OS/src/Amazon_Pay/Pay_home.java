 ...
 * @author Srinivas
 */
public class Pay_home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jInternalFrame1.getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 0, -1, -1));
...
public static void dt() {    
       ...
       Pay_home.date.setText(dtf.format(now));  
      }
...
new Amazon_Pay.Pay_home().setVisible(true);
